...
function shoppingTime(memberId, money) {
    if (memberId == undefined && money == undefined || memberId.length == 0) return `Mohon maaf, toko X hanya untuk member saja`
    if (money < 50000) return `Mohon maaf, uang tidak cukup`

    const brand = {}
    brand[`Sepatu Stacattu`]  = 1500000
    brand[`Baju zoro`]        = 500000
    brand[`Baju H&N`]         = 250000
    brand[`Sweater Unikloh`]  = 175000
    brand[`Casing Handphone`] = 50000

    var result = []; sisa = money
    ...
    shopper[`money`]           = money,
    shopper[`listPurcased`]    = result,
    shopper[`changeMoney`]     = sisa
